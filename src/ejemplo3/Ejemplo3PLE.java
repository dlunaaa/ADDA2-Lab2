...
import ejemplo3.DatosAlumnos.Alumno;
...
//	}
	...
	public static void ejemplo3_model() throws IOException {
		DatosAlumnos.iniDatos("resources/p3/ejemplo3_3.txt");
		
		alumnos = DatosAlumnos.getAlumnos();
		
		AuxGrammar.generate(DatosAlumnos.class,"modelos/ejemplo3.lsi","gurobi_models/ejemplo3.lp");
